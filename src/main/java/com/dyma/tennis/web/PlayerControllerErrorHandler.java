...
import com.dyma.tennis.service.PlayerAreadyExiste;
...
public class PlayerControllerErrorHandler {
    ...
    @ExceptionHandler(PlayerAreadyExiste.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public Error handlePlayerAreadyExiste(PlayerNotFoundException ex) {
        return new Error(ex.getMessage());
    }
